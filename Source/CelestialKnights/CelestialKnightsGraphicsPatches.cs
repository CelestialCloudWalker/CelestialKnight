...
namespace CelestialKnights
{
    ...
    public static class GraphicsPatches
    {
        ...
        public static class HideHair_Patch
        {
            ...
            {
                if (pawn.health.hediffSet.HasHediff(CelestialKnightsDefOf.CelestialKnights_SuitActive))
                {
                    __result = null;
                    return false;
                }
        ...
        public class Patch_PawnRenderNodeWorker_Apparel_Head_CanDrawNow
        {
            ...
            {
                if (parms.pawn.health.hediffSet.HasHediff(CelestialKnightsDefOf.CelestialKnights_SuitActive))
                {
                    __result = false;
                    return false;
                }
